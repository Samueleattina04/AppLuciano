    ...
    <div class="row g-3">
        <div class="col-md-8">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12"><label class="form-label fw-semibold">Oggetto *</label><input type="text" name="subject" class="form-control" value="{{ old('subject') }}" required></div>
                        <div class="col-md-6"><label class="form-label fw-semibold">Mittente</label><input type="text" name="sender" class="form-control" value="{{ old('sender') }}"></div>
                        <div class="col-md-6"><label class="form-label fw-semibold">Destinatario</label><input type="text" name="recipient" class="form-control" value="{{ old('recipient') }}"></div>
                        ...
                        <div class="col-md-4"><label class="form-label fw-semibold">Data Scadenza</label><input type="date" name="due_date" class="form-control" value="{{ old('due_date') }}"></div>
                        <div class="col-md-4"><label class="form-label fw-semibold">Data Promemoria</label><input type="date" name="reminder_date" class="form-control" value="{{ old('reminder_date') }}"></div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12"><label class="form-label fw-semibold">Note</label><textarea name="notes" class="form-control" rows="4">{{ old('notes') }}</textarea></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary w-100 mb-2">Crea Task</button>
