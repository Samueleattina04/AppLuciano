...
<form method="POST" action="{{ route('claims.store') }}">
    ...
    <div class="row g-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3"><label class="form-label fw-semibold">Importo</label><input type="number" name="amount" step="0.01" class="form-control" value="{{ old('amount') }}" required></div>
                        ...
                        <div class="col-md-3"><label class="form-label fw-semibold">Data Risoluzione</label><input type="date" name="resolved_date" class="form-control" value="{{ old('resolved_date') }}"></div>
                        <div class="col-12"><label class="form-label fw-semibold">Motivo *</label><textarea name="reason" class="form-control" rows="3" required>{{ old('reason') }}</textarea></div>
                        <div class="col-12"><label class="form-label fw-semibold">Note</label><textarea name="notes" class="form-control" rows="2">{{ old('notes') }}</textarea></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-warning w-100 mb-2">Crea Reclamo</button>
